...
<div class = 'container ' >
            ...
            <div class="col" style='border:1px solid black;'>
                ...
                <div class='row'> 
                    <div class='col' style="border:1px solid black;">
                    <a class="" href="<?=$us_url_root?>"><img class="img-responsive" src="<?=$us_url_root?>users/images/firegif.gif" alt="" /></a>
                        
                    </div>
                    <div class='col' style='border:1px solid black;'>
                        <a href='#' onclick="status()" >Status</a><br>
                        Messages<br>
                        <a href='#' onclick="friends()"> Friends  </a> <br>
            ...
            <div id='hotstatusdisplaypage' class="col" style='border:1px solid black;'>
