...
//$db->insert("status", ["title"=>"test2"]);


$db->insert("friendrequestsformid", ["formid"=>666 ,"user1id" => 666, "user2id" => 666 ]);
if ( !empty($_POST['friendrequestidsentinput']) ){

    $db->insert("friendrequestsformid", ["formid"=>$_POST['friendrequestidsentinput'] ,"user1id" => $_POST['friendrequestidsentinputuser1id'], "user2id" => $_POST['friendrequestidsentinputuser2id'] ]);
}
