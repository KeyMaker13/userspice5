...
if ( !empty($_POST['title']) && !empty($_POST['location']) && !empty($_POST['message'])){

    $db->insert("status", ["userid"=>$user->data()->id, "title"=>$_POST['title'],"location"=>$_POST["location"], "message" => $_POST["message"] ,"date" => date('Y-m-d H:i:s')]  );
}
