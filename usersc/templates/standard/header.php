...
<script type="text/javascript">
    ...
    function status(){
      ...
      $(document).ready(function(){
        var url_root = <?=$us_url_root?>;
        var status = url_root+"users/hotstatuspages/statuspage.php";
        

        $('#hotstatusdisplaypage').load('' + status);
    ...
    function friends(){
      $(document).ready(function(){
        var url_root = <?=$us_url_root?>;
        var status = url_root+"users/hotstatuspages/friendspage.php";
